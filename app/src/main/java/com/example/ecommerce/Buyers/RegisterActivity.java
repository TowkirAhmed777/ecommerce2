...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputName = (EditText) findViewById(R.id.register__username_input);
        InputPassword = (EditText) findViewById(R.id.register__password_input);
    ...
    private void CreateAccount() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Toast.makeText(this,"please write your number....",Toast.LENGTH_SHORT);
        }
