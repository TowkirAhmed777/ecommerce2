...
//
                int oneTypeProductTPrice = Integer.valueOf(cart.getPrice().replaceAll("[^0-9]", "")) * Integer.valueOf(cart.getQuantity());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        txtMsg1.setText("Congratulation,Your final order has been placed successfully. Soon you will received your order at your door step");
